...
const { hashPassword, comparePasswords, generateToken } = require('../utils/jwt');
...
const login = async(req, res) => {
  ...
  try {
    ...
    // Generar token JWT
    const token = generateToken({ userId: usuario.id, username: usuario.username, role: usuario.rol });
